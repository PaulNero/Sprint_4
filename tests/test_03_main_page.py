...
class TestMainPage():
    ...
    def test_order_page_open_via_header(self):
    ...
    def test_order_page_open_via_body(self):
    ...
    def test_scooter_page_open_via_header(self):
        with allure.step("Клик по кнопке оформления заказа в header"):
    ...
    def test_scooter_page_open_via_status(self):
    ...
    def test_yandex_page_open(self):
