...
class TestQuestion():
    ...
    def setup_class(cls):
        with allure.step(f"Запускаем браузер и переходим на {MainPageLocators.main_link}"):
            ...
            cls.driver = webdriver.Firefox(executable_path=GeckoDriverManager().install(), options=option)
    ...
    def test_how_it_cost_question(self):
    ...
    def test_several_scooters_question(self):
    ...
    def test_how_calculate_rental_time_question(self):
    ...
    def test_can_order_today_question(self):
    ...
    def test_extend_order_earlier(self):
    ...
    def test_chargers_with_scooter_question(self):
    ...
    def test_can_i_cancel_order_question(self):
    ...
    def test_live_outside_question(self):
