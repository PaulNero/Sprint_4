...
@allure.suite("Тестирование блока end 2 end заказа")
class TestEnd2EndOrderPage():
    ...
    @allure.title("01. Проверка создания заказа на самокат, через кнопку 'Заказать' в header сайта")
    ...
    @allure.title("02. Заполняем поле Имя")
    ...
    @allure.title("03. Заполняем поле Фамилия")
    ...
    @allure.title("04. Заполняем поле Адрес")
    ...
    @allure.title("05. Заполняем поле Метро")
    ...
    @allure.title("06. Заполняем поле Номер телефона")
    ...
    @allure.title("09. Выбираем срок аренды")
    ...
    @allure.title("10. Выбираем цвет самоката")
    ...
    @allure.title("11. Заполняем поле коментарий для курьера")
    ...
    @allure.title("12. Подтверждаем создание заказа")
    ...
    @allure.title("13. Переходим на окно статуса")
    ...
    @allure.title("16. Проверяем переход на главную, после завершения отмены заказа")
